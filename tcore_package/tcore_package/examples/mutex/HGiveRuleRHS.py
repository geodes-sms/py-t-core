...
class HGiveRuleRHS(HimesisPostConditionPattern):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HGiveRuleRHS.
        """
        # Create the himesis graph
        EDGE_LIST = [(3, 0), (0, 4), (2, 1), (1, 4)]
        
        super(HGiveRuleRHS, self).__init__(name='HGiveRuleRHS', num_nodes=5, edges=EDGE_LIST)
...
S'int'
p6
L128109589447366193026876325095916544650L
sb.""")
...
S'int'
p6
L177624418768214664019156108454313732585L
sb.""")
...
S'int'
p6
L65279578244024242503641241558378633882L
sb.""")
...
S'int'
p6
L80242969720223182778476110579653009519L
sb.""")
...
S'int'
p6
L63470687038304575917707628194018684606L
sb.""")
...
S'int'
p6
L67506875502750692194397584738302981614L
sb.""")
        from HGiveRuleLHS import HGiveRuleLHS
        self.pre = HGiveRuleLHS()
