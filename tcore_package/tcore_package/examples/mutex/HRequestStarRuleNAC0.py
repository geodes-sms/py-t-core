...
class HRequestStarRuleNAC0(HimesisPreConditionPatternNAC):
    def __init__(self, LHS):
        """
        Creates the himesis graph representing the AToM3 model HRequestStarRuleNAC0.
        """
        # Create the himesis graph
        EDGE_LIST = [(2, 0), (1, 2)]
        
        super(HRequestStarRuleNAC0, self).__init__(name='HRequestStarRuleNAC0', num_nodes=3, edges=EDGE_LIST, LHS=LHS)
...
S'int'
p6
L279590811255854037561210139892396449060L
sb.""")
...
.""")
        self.vs[2]["MT_label__"] = pickle.loads("""S'8'
.""")
...
S'int'
p6
L46819431027326638697963918096443500841L
sb.""")
        
        # Load the bridge between this NAC and its LHS
        from HRequestStarRuleNAC0Bridge import HRequestStarRuleNAC0Bridge
        self.bridge = HRequestStarRuleNAC0Bridge()
