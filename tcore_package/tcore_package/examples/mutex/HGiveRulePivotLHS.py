...
class HGiveRulePivotLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HGiveRulePivotLHS.
        """
        # Create the himesis graph
        EDGE_LIST = [(3, 0), (0, 4), (2, 1), (1, 3)]
        
        super(HGiveRulePivotLHS, self).__init__(name='HGiveRulePivotLHS', num_nodes=5, edges=EDGE_LIST)
...
S'int'
p6
L12981422283108575041802580714357437051L
sb.""")
...
S'int'
p6
L17016231759602513030309902885660816476L
sb.""")
...
S'int'
p6
L135551964233503244077595512429499526981L
sb.""")
...
S'int'
p6
L47638695076110829248083297052131318589L
sb.""")
        self.vs[3]["MT_subtypeMatching__"] = pickle.loads("""I00
.""")
        self.vs[3]["MT_pivotIn__"] = pickle.loads("""S'p'
.""")
...
S'int'
p6
L253002741093312474840776146489905966105L
sb.""")
...
S'int'
p6
L290412129272398026906174733005688635255L
sb.""")
