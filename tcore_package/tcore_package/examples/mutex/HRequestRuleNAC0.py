...
class HRequestRuleNAC0(HimesisPreConditionPatternNAC):
    def __init__(self, LHS):
        """
        Creates the himesis graph representing the AToM3 model HRequestRuleNAC0.
        """
        # Create the himesis graph
        EDGE_LIST = [(3, 0), (0, 1), (2, 4), (1, 2)]
        
        super(HRequestRuleNAC0, self).__init__(name='HRequestRuleNAC0', num_nodes=5, edges=EDGE_LIST, LHS=LHS)
...
S'int'
p6
L294857366286203551603529973469871452817L
sb.""")
...
S'int'
p6
L118675385239306709975236536046841364997L
sb.""")
...
S'int'
p6
L67115021767075456899599496114103751668L
sb.""")
...
S'int'
p6
L170586602450123909748373337875440342345L
sb.""")
...
S'int'
p6
L107602115318223042149806979354853347618L
sb.""")
...
S'int'
p6
L268490510992271139794629837696880387455L
sb.""")
        
        # Load the bridge between this NAC and its LHS
        from HRequestRuleNAC0Bridge import HRequestRuleNAC0Bridge
        self.bridge = HRequestRuleNAC0Bridge()
