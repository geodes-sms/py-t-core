...
class HRequestRuleLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HRequestRuleLHS.
        """
        # Create the himesis graph
        EDGE_LIST = []
        
        super(HRequestRuleLHS, self).__init__(name='HRequestRuleLHS', num_nodes=2, edges=EDGE_LIST)
...
S'int'
p6
L71615516216911659871572190042084773306L
sb.""")
...
sb.""")
        ...
        self.NACs = [HRequestRuleNAC0(LHS=self)]
