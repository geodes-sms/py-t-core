...
class HResourceRuleLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HResourceRuleLHS.
        """
        # Create the himesis graph
        EDGE_LIST = []
        
        super(HResourceRuleLHS, self).__init__(name='HResourceRuleLHS', num_nodes=0, edges=EDGE_LIST)
...
S'int'
p6
L105607935948054044945830258901554412824L
sb.""")
