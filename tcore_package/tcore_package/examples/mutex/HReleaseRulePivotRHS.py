...
class HReleaseRulePivotRHS(HimesisPostConditionPattern):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HReleaseRulePivotRHS.
        """
        # Create the himesis graph
        EDGE_LIST = [(2, 0), (0, 1)]
        
        super(HReleaseRulePivotRHS, self).__init__(name='HReleaseRulePivotRHS', num_nodes=3, edges=EDGE_LIST)
...
S'int'
p6
L54718949582657985530227949708710718148L
sb.""")
...
S'int'
p6
L303891911525732987251186087532029333633L
sb.""")
...
S'int'
p6
L148381046541047846076593011693402756380L
sb.""")
...
S'int'
p6
L191751947581455322461465139637743829927L
sb.""")
        from HReleaseRulePivotLHS import HReleaseRulePivotLHS
        self.pre = HReleaseRulePivotLHS()
