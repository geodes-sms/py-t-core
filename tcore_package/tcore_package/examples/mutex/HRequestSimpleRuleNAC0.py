...
class HRequestSimpleRuleNAC0(HimesisPreConditionPatternNAC):
    def __init__(self, LHS):
        """
        Creates the himesis graph representing the AToM3 model HRequestSimpleRuleNAC0.
        """
        # Create the himesis graph
        EDGE_LIST = [(2, 0), (1, 2)]
        
        super(HRequestSimpleRuleNAC0, self).__init__(name='HRequestSimpleRuleNAC0', num_nodes=3, edges=EDGE_LIST, LHS=LHS)
...
S'int'
p6
L54570948111353959965479959327960326654L
sb.""")
...
S'int'
p6
L77183823705861350046401569684963149040L
sb.""")
        
        # Load the bridge between this NAC and its LHS
        from HRequestSimpleRuleNAC0Bridge import HRequestSimpleRuleNAC0Bridge
        self.bridge = HRequestSimpleRuleNAC0Bridge()
