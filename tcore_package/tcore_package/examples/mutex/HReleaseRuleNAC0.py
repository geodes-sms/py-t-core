...
class HReleaseRuleNAC0(HimesisPreConditionPatternNAC):
    def __init__(self, LHS):
        """
        Creates the himesis graph representing the AToM3 model HReleaseRuleNAC0.
        """
        # Create the himesis graph
        EDGE_LIST = [(2, 0), (1, 2)]
        
        super(HReleaseRuleNAC0, self).__init__(name='HReleaseRuleNAC0', num_nodes=3, edges=EDGE_LIST, LHS=LHS)
...
S'int'
p6
L242580904126300241053846154793939493732L
sb.""")
...
S'int'
p6
L293106342214416328390688397337429730265L
sb.""")
...
S'int'
p6
L229632518997480035825079081227934310374L
sb.""")
        
        # Load the bridge between this NAC and its LHS
        from HReleaseRuleNAC0Bridge import HReleaseRuleNAC0Bridge
        self.bridge = HReleaseRuleNAC0Bridge()
