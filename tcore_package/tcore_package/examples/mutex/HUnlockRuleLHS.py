...
class HUnlockRuleLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HUnlockRuleLHS.
        """
        # Create the himesis graph
        EDGE_LIST = [(2, 0), (0, 3), (2, 1), (1, 3)]
        
        super(HUnlockRuleLHS, self).__init__(name='HUnlockRuleLHS', num_nodes=4, edges=EDGE_LIST)
...
S'int'
p6
L244865194599059437099551254223833685279L
sb.""")
...
S'int'
p6
L17798216907319587723110452966882408230L
sb.""")
        self.vs[1]["MT_subtypeMatching__"] = pickle.loads("""I00
.""")
        self.vs[1]["MT_label__"] = pickle.loads("""S'4'
.""")
...
S'int'
p6
L299309329986608680380895518689701932810L
sb.""")
...
S'int'
p6
L217939205784801279257202689665291555229L
sb.""")
...
S'int'
p6
L233168384718587547436225817521095356033L
sb.""")
