...
class HHoldRuleLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HHoldRuleLHS.
        """
        # Create the himesis graph
        EDGE_LIST = []
        
        super(HHoldRuleLHS, self).__init__(name='HHoldRuleLHS', num_nodes=2, edges=EDGE_LIST)
...
S'int'
p6
L159805472501531992406939813172861382676L
sb.""")
...
S'int'
p6
L77933946834667379458068160696837287375L
sb.""")
...
S'int'
p6
L163261784310981906636000487760777815800L
sb.""")
        
        # Load the NACs
        from HHoldRuleNAC0 import HHoldRuleNAC0
        from HHoldRuleNAC1 import HHoldRuleNAC1
        self.NACs = [HHoldRuleNAC0(LHS=self), HHoldRuleNAC1(LHS=self)]
