...
class HPassRuleNAC0(HimesisPreConditionPatternNAC):
    def __init__(self, LHS):
        """
        Creates the himesis graph representing the AToM3 model HPassRuleNAC0.
        """
        # Create the himesis graph
        EDGE_LIST = [(2, 0), (1, 2)]
        
        super(HPassRuleNAC0, self).__init__(name='HPassRuleNAC0', num_nodes=3, edges=EDGE_LIST, LHS=LHS)
...
p1
.""").replace("@n", "\n")
        self["name"] = pickle.loads("""S'HPassRuleNAC0'
p1
.""")
...
S'int'
p6
L115463966035367520473704701271523039316L
sb.""")
...
S'int'
p6
L314698708587429013560569209317735942661L
sb.""")
        
        # Load the bridge between this NAC and its LHS
        from HPassRuleNAC0Bridge import HPassRuleNAC0Bridge
        self.bridge = HPassRuleNAC0Bridge()
