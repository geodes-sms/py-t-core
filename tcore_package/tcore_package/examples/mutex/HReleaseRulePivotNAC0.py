...
class HReleaseRulePivotNAC0(HimesisPreConditionPatternNAC):
    def __init__(self, LHS):
        """
        Creates the himesis graph representing the AToM3 model HReleaseRulePivotNAC0.
        """
        # Create the himesis graph
        EDGE_LIST = [(2, 0), (1, 2)]
        
        super(HReleaseRulePivotNAC0, self).__init__(name='HReleaseRulePivotNAC0', num_nodes=3, edges=EDGE_LIST, LHS=LHS)
...
S'int'
p6
L94224743539979633993487413480626122726L
sb.""")
...
S'int'
p6
L272549578259224044649192042195280222873L
sb.""")
...
S'int'
p6
L8523105835582321039251205449097727101L
sb.""")
        
        # Load the bridge between this NAC and its LHS
        from HReleaseRulePivotNAC0Bridge import HReleaseRulePivotNAC0Bridge
        self.bridge = HReleaseRulePivotNAC0Bridge()
